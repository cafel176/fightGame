...
public class TransitionalObjectEditor : Editor
{
    ...
    static Color headingsColourPro = new Color(0.6f, 0.918f, 1, 1);
    static Color subHeadingsColourPro = new Color(1, 1, 1, 1);
    ...
    public override void OnInspectorGUI()
    {
        ...
        boldLabel.normal.textColor = headingsColourPro;
        ...
        if(current.transitions.Length > 0)
        {
            ...
            using(new ColourChange(headingsColourPro))
        ...
        if(current.alphaOrColourComponentCount > 0)
        {
            ...
            if(EditorGUILayout.BeginFadeGroup(current.effectedRenderersGroup.faded))
                using(new Vertical(mainContentStyle))
                {
                    ...
                    #region Tools
                    using(new ColourChange(subHeadingsColourPro))
    ...
    {
        #region Initialise
        GUIStyle centeredLabel = EditorStyles.boldLabel;
        centeredLabel.alignment = TextAnchor.MiddleCenter;
        centeredLabel.normal.textColor = Color.white;

        if(!loaded)
        {
            headingsColourPro = new Color(EditorPrefs.GetFloat("HeadingR"), EditorPrefs.GetFloat("HeadingG"), EditorPrefs.GetFloat("HeadingB"), EditorPrefs.GetFloat("HeadingA"));
            subHeadingsColourPro = new Color(EditorPrefs.GetFloat("SubHeadingR"), EditorPrefs.GetFloat("SubHeadingG"), EditorPrefs.GetFloat("SubHeadingB"), EditorPrefs.GetFloat("SubHeadingA"));
        ...
        using(new FixedWidthLabel("Headings Colour"))
            headingsColourPro = EditorGUILayout.ColorField(headingsColourPro);

        using(new FixedWidthLabel("Sub Headings Colour"))
            subHeadingsColourPro = EditorGUILayout.ColorField(subHeadingsColourPro);
        ...
        if(GUI.changed)
        {
            EditorPrefs.SetFloat("HeadingR", headingsColourPro.r);
            EditorPrefs.SetFloat("HeadingG", headingsColourPro.g);
            EditorPrefs.SetFloat("HeadingB", headingsColourPro.b);
            EditorPrefs.SetFloat("HeadingA", headingsColourPro.a);

            EditorPrefs.SetFloat("SubHeadingR", subHeadingsColourPro.r);
            EditorPrefs.SetFloat("SubHeadingG", subHeadingsColourPro.g);
            EditorPrefs.SetFloat("SubHeadingB", subHeadingsColourPro.b);
            EditorPrefs.SetFloat("SubHeadingA", subHeadingsColourPro.a);
